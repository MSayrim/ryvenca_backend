 ...
 * @param paletteId    curated palette the outfit's own colors literally come from (null if none)
 * @param paletteScore 0..1 best palette fit (neutrals get an allowance), used for scoring
 * @param paletteMatched whether {@link #paletteId} is worth naming
 ...
 */
public record ColorAnalysis(double score, String paletteId, double paletteScore, boolean paletteMatched, double ruleScore,
