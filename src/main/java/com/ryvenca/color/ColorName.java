...
public enum ColorName implements Labeled {
    ...
    ColorName(String hex, ColorTone tone, String... prototypeHexes) {
        this.hex = hex;
        this.tone = tone;
